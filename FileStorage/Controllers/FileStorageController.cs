...
public class FileStorageController : ControllerBase {
        ...
        try {
            ...
            if (fileSection == null) {
                var unknown = new FileUploadResultModel() {
                    ObjectId = null, FileName = "Unknown", IsSuccessful = false, ErrorMessage = "Unknown content"
                };
                return Ok(unknown);
            }
    ...
    public async Task<IActionResult> GetFileInfo(string objectId, CancellationToken cancellationToken) {
        ...
        return Ok(new {
            Id = fileInfo.Id.ToString(), Filename = fileName, ContentType = contentType, Length = fileInfo.Length
        });
    }
